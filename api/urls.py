...
from .views import UsuarioViewSet, AdvogadoViewSet, ClienteViewSet, ProcessoViewSet, ReuniaoConsultaViewSet, HonorarioViewSet, RelatorioFinanceiroViewSet, ComunidadeViewSet, PostagemViewSet, EventoViewSet
...
router.register(r'reunioes', ReuniaoConsultaViewSet)
