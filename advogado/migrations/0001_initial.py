    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('ADV', 'Advogado'), ('ADM', 'Administrador')], max_length=3)),
        ...
        migrations.CreateModel(
            name='Advogado',
            fields=[
                ('usuario', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='advogado.usuario')),
