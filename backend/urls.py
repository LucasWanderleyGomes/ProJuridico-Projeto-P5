...
from comunidade.api.urls import router as comunidadeRouter, eventos_router, blogPosts_router
...
urlpatterns = [
   ...
   path("api/v2/", include(eventos_router.urls)),
   path("api/v2/", include(blogPosts_router.urls)),
